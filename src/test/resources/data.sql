...
-- テスト用得意先データの追加
MERGE INTO customers (customer_code, name, name_kana, postal_code, address, phone, email, fax, contact_person, payment_terms, status, notes, created_at, updated_at, created_by, updated_by, deleted) KEY(customer_code, deleted) VALUES
